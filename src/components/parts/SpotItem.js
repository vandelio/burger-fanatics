...
export default function RecipeReviewCard(props) {
  ...
  const imageArray = [burgerHeadImage6,burgerHeadImage7,burgerHeadImage8,burgerHeadImage9,burgerHeadImage10]
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        ...
        <div className="ratingRow-container">
            <Box sx={{display:'flex',flexDirection:'column', width:'100%'}} >
                <Button variant="contained" onClick={handleSetShowReviewModal}>Review this place</Button>
            </Box>
            <Box  className="ratingRowWrap">

              <ReviewSpot setShowReviewModal={handleSetShowReviewModal} showReviewModal={showReviewModal} />
              <p>
